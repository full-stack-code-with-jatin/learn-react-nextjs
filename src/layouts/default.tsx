...
const navigation = [
  ...
  { name: "Products", href: "/basics/products", current: false },
  { name: "Speakers", href: "/basics/speakers", current: false },
  { name: "Albums", href: "/basics/albums", current: false },
  { name: "Posts", href: "/basics/posts", current: false },
];
const user = {
...
const DefaultLayout = ({
  ...
  return (
    <ThemeProvider>
      <div className={clsx(firaCode.className, "min-h-full")}>
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <span className="text-white text-xl">Learning React</span>
                    </div>
